<?php
/*
	Plugin Name: Cookie Law Info Accepting By Scroll [Unmaintained]
	Plugin URI: http://www.syriusweb.com
	Description: This feature has been introduced in the original Cookie Law Plugin Info plugin by Richard Ashby, so that is no longer necessary to use.
	Version: 1.2
